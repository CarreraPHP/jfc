angular.module('JFC.controller', [])
    ...
    .controller("ConfigController", ["$scope", "$route","$http","$localStorage", ConfigController])    
    .controller("AdminController", ["$scope", "$route","$http","$timeout", "$location", AdminController])
